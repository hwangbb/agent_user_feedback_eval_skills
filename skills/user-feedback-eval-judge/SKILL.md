...
- Read [references/user-feedback-regression-standard-clean.md](references/user-feedback-regression-standard-clean.md) before scoring.
- Read [references/judge-examples-clean.md](references/judge-examples-clean.md) when you need examples of格式映射、有效评分和无效 judge setup.
